...
function conciseOutput(a, runGroups) {
  ...
  _.each(runGroups, function runGroupScore(rg) {
...
function conciseHeader(runGroups) {
  var header = ["Order", "Bib", "Name", "Division", "Team"];
  _.each(runGroups, function rgHeader(rg) {
    header.push(rg);
  });
  header.push("Score");
  return header;
...
module.exports = function generateResults(
  seriesName, seriesYear, comp, division, options, callback) {
